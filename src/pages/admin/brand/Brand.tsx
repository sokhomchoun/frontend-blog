    ...
    return (
                                            ...
                                            <div className="w-full">
                                                <div className="w-full bg-white rounded-md">
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        <ButtonGenerateIdComponent onClick={handleInputBrand} isTextGenerator={isTextGenerator} />
                                                        <ButtonCancelComponent onClick={handleCleardata} />
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="px-4">
                                    ...
                                    <div className="flex px-4 py-2 rounded-md mb-2 ml-2 border-2 border-gray-300 overflow-hidden max-w-xs font-[sans-serif]">
                                        ...
                                        <input
                                            ...
                                            type="text" 
                                            onKeyDown={handleSearchBrandId} 
                                            placeholder="Search Brand No..." 
                                    ...
                                    <div className="font-sans overflow-x-auto p-2">
                                            <table className="min-w-full bg-white">
                                                ...
                                                <tbody className="whitespace-nowrap">
                                                    ...
                                                    { (Array.isArray(dataSearchByBrandId) && dataSearchByBrandId.length > 0 ? dataSearchByBrandId : itemBrands).map((items, index) => {
                                                        return (
                                                            <tr key={index} className="hover:bg-blue-50 even:bg-gray-100">
                                                                <td className="px-4 text-[15px] text-gray-800 font-semibold border">{items.brand_id}</td>
                                                                <td className="px-4 text-[15px] text-gray-800 border">
                                                                    <img src={`${import.meta.env.VITE_IMAGE_URL}${items.brand_img}`} className="w-8 h-8 object-cover" alt="" />
                                                                </td>
                                                                <td className="px-4 text-[15px] text-gray-800 border">{items.brand}</td>
                                                                ...
                                                                <td className="px-4 border relative">
                                                                    <button onClick={() => toggleMenu(items)} className="p-2 rounded-full hover:bg-gray-200 transition-colors" title="More options">
                                                                    ...
                                                                    { openMenuId === items.brand_id && (
                                                                        <div ref={menuRef} className="text_menu absolute top-0 left-14 bg-white shadow-lg rounded border">
                                                                            <p onClick={() => handleEditBrand(items)} className="px-4 py-2 text-[15px] hover:bg-gray-100 cursor-pointer flex items-center gap-2">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-gray-500" viewBox="0 0 348.882 348.882">
                                                                                    <path
                                                                            ...
                                                                            <p onClick={() => handleDeleteBrand(items)} className="px-4 py-2 text-[15px] hover:bg-gray-100 cursor-pointer flex items-center gap-2">
                                            ...
                                            <ul className="flex space-x-4 justify-center mt-8 font-[sans-serif]">
                                                <li onClick={() => handlePageChange(currentPage - 1)} className={`flex items-center justify-center shrink-0 w-9 h-9 rounded-md cursor-pointer ${currentPage === 1 ? 'bg-gray-100 text-gray-400' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'}`}>
                                                ...
                                                <li onClick={() => handlePageChange(currentPage + 1)} className={`flex items-center justify-center shrink-0 w-9 h-9 rounded-md cursor-pointer ${currentPage === totalPages ? 'bg-gray-100 text-gray-400' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'}`} >
            ...
            { modalOpen && (
                <ModalGenerateIdComponent 
                    titleModal="Do you want to generate Brand Id ?" 
            ...
            { modalDelete && (
                <ModalDeleteComponent 
                    titleModal="Do you want to delete brand by Id"
